...
EVENTS_TABLE_SESSION_ON_EVENTS_COLUMNS = f"""
    , soe_min_timestamp DateTime64(6, 'UTC')
    , soe_max_timestamp DateTime64(6, 'UTC')

    , soe_pageview_prio_timestamp_min DateTime64(6, 'UTC')
    , soe_pageview_prio_timestamp_max DateTime64(6, 'UTC')
