...
export const endpointLogic = kea<endpointLogicType>([
    ...
    actions({
        ...
        setSyncFrequency: (syncFrequency: 'hourly' | 'daily' | 'weekly' | null) => ({ syncFrequency }),
        ...
        materializeEndpoint: (name: string, syncFrequency: 'hourly' | 'daily' | 'weekly') => ({
            name,
            syncFrequency,
        }),
    ...
    reducers({
        ...
        syncFrequency: [
            null as 'hourly' | 'daily' | 'weekly' | null,
            {
